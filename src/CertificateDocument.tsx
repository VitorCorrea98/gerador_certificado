					...
					<View style={styles.contentContainer}>
						<View style={styles.mainContent}>
							...
							<Text style={styles.bodyText}>
								concluiu o{" "}
								<Text style={styles.bold}>{courseInfo.nomeCurso}</Text>, na
								função de <Text style={styles.bold}>{student.Funcao}</Text>,
								realizado pela Secretaria Municipal de Saúde do Rio de Janeiro,
								no período de {courseInfo.periodo}, com carga horária de{" "}
