...
import { Lock, User, Baby, Activity } from 'lucide-react';
    ...
    <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="bg-blue-600 p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-white">Maternidade Leila Diniz</h1>
          <p className="text-blue-100 text-sm mt-1">Sistema de Gestão de Certificados</p>
        </div>
        ...
        <div className="p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-600 ml-1">Usuário</label>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-400">© 2024 Secretaria Municipal de Saúde</p>
          </div>
        </div>
      </div>
    </div>
